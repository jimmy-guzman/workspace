    ...
    <section className='contact grid__row'>
      <div className='card grid__col--6'>
        ...
        <ul>
          ...
          <li>
            <a href='https://www.linkedin.com/in/jimmy-guzman-87bb2714a/' target='_blank' rel='noopener noreferrer'>
              <LinkedinSVG width='50' height='50' />
            </a>
          </li>
          <li>
            <a href='https://github.com/jimmy-guzman' target='_blank' rel='noopener noreferrer'>
